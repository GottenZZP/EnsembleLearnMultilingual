...
from transformers import RobertaModel, RobertaTokenizer, RobertaPreTrainedModel, RobertaConfig
...
class RoBERTaAndTextCnnForSeq(RobertaPreTrainedModel):
    def __init__(self, config, filters, filter_num):
        super(RoBERTaAndTextCnnForSeq, self).__init__(config)
